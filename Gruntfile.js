  ...
  grunt.initConfig({
    replace: {
      date: {
        ...
        files: [
          {src: ['src/People/package/package.config'], dest: './'}
        ]
      },
      scversion: {
        options: {
    ...
    bump: {
      options: {
        files: ['package.json', 'src/People/package/package.config'],
        commit: true,
        commitMessage: '%VERSION%',
        commitFiles: ['package.json', 'src/People/package/package.config'],
        createTag: true,
        tagName: '%VERSION%',
